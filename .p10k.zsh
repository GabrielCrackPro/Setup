# Generated by Powerlevel10k configuration wizard on 2022-04-20 at 18:59 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=155
  ...
  ###########[ ip: ip address and bandwidth usage for a specified network interface ]###########
  # IP color.
  typeset -g POWERLEVEL9K_IP_FOREGROUND=69
  ...
  # ${P9K_IP_RX_RATE:+ %70F⇣$P9K_IP_RX_RATE}${P9K_IP_TX_RATE:+ %215F⇡$P9K_IP_TX_RATE}'
  ...
  function prompt_example() {
    p10k segment -f 208 -i ⚙️ -t 'Hello, $USER!'
  }
